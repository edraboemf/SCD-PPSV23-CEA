...
digraph decision_tree {
  ...
  ## PPSV23 subtree
  {
    ...
    ## Invisible edges keep them evenly spaced
    ipd_inf -> nonipd_inf -> no_inf [style = invis, weight = 100]
  }
  ...
  no_inf_alive [label = 'Alive', width = 2.2, height = 2.0]
  no_inf -> no_inf_alive
